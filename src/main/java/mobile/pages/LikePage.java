...
public class LikePage {
    ...
    public final SelenideElement checkLikeValueComment = $(AppiumBy.id("com.hitechrush.jaxarush:id/likesCount"));
    public final SelenideElement checkLikeValueLecture = $(AppiumBy.id("com.hitechrush.jaxarush:id/lectureLikesCount"));
